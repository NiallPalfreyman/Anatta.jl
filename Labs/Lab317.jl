#========================================================================================#
#	Laboratory 317: Cooperative problem-solving.
#
...
[
    Activity(
        """
        Hi! Welcome to Anatta Subject 317: Exploration enables cooperative problem-solving!
        ...
        passed on, inherited and used by the entire colony over generations. Is this not a kind
        of "group inheritance"?
        ...
        think of, that are constructed and used by a GROUP of humans?
        """,
    ...
    Activity(
        """
        Now do the following. Move the slider prob_birth down from 1.0 to 0.9. This makes it
        significantly (10%) harder for new agents (whether Cooperators or Defectors) to be born.
    ...
    Activity(
        ...
        neighbourhoods, what forces the agents to seek ways of cooperating with each other is the
        Limitation of access to this resource.
        
        You can get an idea of how this works if you again set up the demonstration with
        prob_birth==0.9, and then step slowly through it. You will notice that the blue Defectors
    ...
    Activity(
        """
        Now set the prob_birth slider to 0.93 and either start or step through a new run. Here, the
        Cooperators are able to survive robbery by the Defectors by consolidating themselves into
        ...
        Feel free now to move on to lab 318, in which I describe the research project! :)
        """,
        "",
        x -> true
    ),
